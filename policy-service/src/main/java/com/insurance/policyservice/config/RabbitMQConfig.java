...
/**
 * RabbitMQ topology and message converter for SmartSure events.
 */
@Configuration
public class RabbitMQConfig {
    ...
    public Queue policyQueue() {
        return QueueBuilder.durable(POLICY_QUEUE)
    ...
    @Bean
    public Binding policyBinding(Queue policyQueue, TopicExchange smartSureExchange) {
        return BindingBuilder.bind(policyQueue)
                .to(smartSureExchange)
                .with(POLICY_ROUTING_KEY);
    }
